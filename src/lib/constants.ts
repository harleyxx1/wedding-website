...
export const WEDDING_DATA = {
  ...
  ceremony: {
    ...
    address: '123 Garden Road, Tagaytay City, Cavite',
  ...
  accommodations: [
    {
      ...
      address: 'Km. 60 Aguinaldo Highway, Tagaytay City',
      phone: '+63 46 413 1000',
      bookingUrl: 'https://www.taalvistahotel.com',
    ...
    },
    {
      ...
      address: 'Calamba Road, Tagaytay City',
      phone: '+63 46 413 2000',
      bookingUrl: 'https://www.discoverysuites.com',
      bookingCode: 'HARLEYANGELICA2027',
    ...
    },
    {
      ...
      phone: '+63 46 413 3000',
      bookingUrl: 'https://www.thelakehotel.com',
  ...
  travel: {
    ...
    airportCode: 'MNL',
    distanceFromVenue: '65 km (1.5-2 hours drive)',
  ...
  faqs: [
    ...
    {
      id: '10',
      question: 'How do I get to Tagaytay from Manila?',
      answer: 'Tagaytay is about 1.5-2 hours from Manila via SLEX and Tagaytay-Nasugbu Highway. We recommend using Waze or Google Maps for real-time directions.',
      category: 'Travel',
    },
  ] as FAQItem[],
  ...
  dressCode: {
    ...
    colorPalette: ['#8B7355', '#D4AF37', '#E8D4A0', '#A89080', '#9B7EBD', '#D4B5E8'],
  } as DressCode,
};
